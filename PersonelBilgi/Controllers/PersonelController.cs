...
namespace PersonelBilgi.Controllers
{
    public class PersonelController : ApiController
    {
        ...
        {
            string query = @"
                            select PersonelId,PersonelAd,Departman,
                            convert (varchar(10),GirisTarihi,120) as GirisTarihi,FotografAd
                            from dbo.PERSONEL                            
                            ";
        ...
        [Route("_api/Personel/GetAllDepartmanAdlari")]
        [HttpGet]
